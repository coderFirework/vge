...
$("#qxds").click(function () {
    ...
    oDiv.style.zIndex = "1003";
    document.body.appendChild(oDiv);
    createGraph2("全区统计", "qxyytj", allarr[0].substring(1), allarr[1]);
})
//面积统计
// $("#as").click(function () {
//     var min = "30";
...
function getAllArea() {
    ...
    createGraph2("全区统计(单位:亩)", "qxyytj", allarr[0].substring(1));
            hideModal()
        },
        error: function (data) {
            console.log("错误:" + data);
...
//全县柱状图
function createGraph2(name, id, all) {
    // all=all.toFixed(2);
    // yt=yt.toFixed(2);
    // wy=wy.toFixed(2);
    // wd=wd.toFixed(2);
...
function getCount() {
    ...
    document.body.appendChild(root);
    createGraph3("全区统计(单位:亩)", "qxyytj", allarr[1]);
            hideModal()
        },
        error: function (data) {
            console.log("错误:" + data);
...
//数量统计
function createGraph3(name, id, all) {
    // all=all.toFixed(2);
    // yt=yt.toFixed(2);
    // wy=wy.toFixed(2);
    // wd=wd.toFixed(2);
